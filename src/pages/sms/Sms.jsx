...
import SmsCompo from '../../component/SmsCompo'
        ...
        <div className="flex-1 overflow-scroll h-[100vh]">
            ...
            <div className="px-6">
                ...
                <div className="border-b border-gray-200 pb-2 flex gap-6 items-center md:justify-start px- my-5 over">
                    ...
                    <div className="mon_navs relative">
                        <Link to={'/sms'}>
                            <button className="font-normal text-sm flex gap-3 items-center">SMS <span className="w-10 h-6 text-white nav flex justify-center items-center bg-slate-100 rounded-full">1</span></button>
                        </Link>
                    </div>
                    <div className="mon_navs relative">
                        <Link to={'/phonebook'}>
