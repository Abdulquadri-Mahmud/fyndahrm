                ...
                <div className="border-b border-gray-200 pb-2 flex gap-6 items-center md:justify-start px- my-5 over">
                    ...
                    <div className="mon_navs relative">
                        <Link to={'/call_recording'}>
                            <button className="font-normal text-sm flex gap-3 items-center color">Call recording <span className="w-10 h-6 text-white flex justify-center items-center nav rounded-full">0</span></button>
                        </Link>
                    </div>
                    <div className="mon_navs relative">
