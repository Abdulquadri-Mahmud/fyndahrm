...
import BrowsermanagmentCompo from '../../component/BrowsermanagmentCompo'
                ...
                <div className="border-b border-gray-200 pb-2 flex gap-6 items-center md:justify-start px- my-5 over">
                    ...
                    <div className="mon_navs relative">
                        <Link to={'/browser_management'}>
                            <button className="font-normal text-sm flex gap-3 items-center color">Browser management</button>
                        </Link>
                    </div>
                    <div className="mon_navs relative">
